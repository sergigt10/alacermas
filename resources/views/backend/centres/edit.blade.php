    ...
    <div class="main-panel">        
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h2>Modificar centre</h2>
                        <p> * Camps obligatoris </p>
                        <br>
                        <form class="forms-sample" method="post" action="{{ route('backend.centres.update', ['centre' => $centre->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            @error('titol_esp')
                            ...
                            <div class="form-group">
                                ...
                                <input name="titol_esp" type="text" class="form-control @error('titol_esp') is-invalid @enderror" id="exampleInputEmail3" placeholder="Títol ESP" value="{{ $centre->titol_esp }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail3">Títol CAT *:</label>
                                <input name="titol_cat" type="text" class="form-control @error('titol_cat') is-invalid @enderror" id="exampleInputEmail3" placeholder="Títol CAT" value="{{ $centre->titol_cat }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail3">Títol ENG *:</label>
                                <input name="titol_eng" type="text" class="form-control @error('titol_eng') is-invalid @enderror" id="exampleInputEmail3" placeholder="Títol ENG" value="{{ $centre->titol_eng }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail3">Títol FRA *:</label>
                                <input name="titol_fra" type="text" class="form-control @error('titol_fra') is-invalid @enderror" id="exampleInputEmail3" placeholder="Títol FRA" value="{{ $centre->titol_fra }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail3">Localització del centre:</label>
                                <input name="localitzacio" type="text" class="form-control @error('localitzacio') is-invalid @enderror" id="exampleInputEmail3" placeholder="Localització del centre" value="{{ $centre->localitzacio }}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail3">Descripció ESP *:</label>
                                <input id="descripcio_esp" type="hidden" name="descripcio_esp" value="{{ $centre->descripcio_esp }}">
                                <trix-editor 
                            ...
                            <div class="form-group">
                                ...
                                <input id="descripcio_cat" type="hidden" name="descripcio_cat" value="{{ $centre->descripcio_cat }}">
                                <trix-editor 
                            ...
                            <div class="form-group">
                                ...
                                <input id="descripcio_eng" type="hidden" name="descripcio_eng" value="{{ $centre->descripcio_eng }}">
                                <trix-editor 
                            ...
                            <div class="form-group">
                                ...
                                <input id="descripcio_fra" type="hidden" name="descripcio_fra" value="{{ $centre->descripcio_fra }}">
                                <trix-editor 
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <div class="form-check form-check-danger" style="float:right;">
                                                        <img src='{{ asset("/storage/$centre->imatge1") }}' alt="Alacermas" with=200 height=92>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
