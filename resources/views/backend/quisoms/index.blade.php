                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="order-listing" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($quisoms as $quisom)
                                            <tr>
                                                <td>
                                                    <a href="{{ route('backend.quisoms.edit', ['quisom' => $quisom->id]) }}" style="color: black;">
                                                        Qui som
                                                    </a>
                                                </td>
                                                <td>
                                            ...
                                            <div class="modal fade" id="exampleModalCenter{{$quisom->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    ...
                                                    <div class="modal-body">
                                                        Segur que vols esborrar: Qui som
                                                    </div>
                                                        <div class="modal-footer">
                                                            <form class="pull-right" action="{{ route('backend.quisoms.destroy', ['quisom' => $quisom->id]) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
