                                    ...
                                    <tbody>
                                        @foreach($productes as $producte)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" style="color: black;" data-toggle="modal" data-target="#exampleModalCenter{{$producte->id}}">
                                                        <i class="mdi mdi-close-circle menu-icon"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            <div class="modal fade" id="exampleModalCenter{{$producte->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    ...
                                                    <div class="modal-body">
                                                        Segur que vols esborrar: {{ $producte->nom_cat }}
                                                    </div>
                                                        <div class="modal-footer">
                                                            <form class="pull-right" action="{{ route('backend.productes.destroy', ['producte' => $producte->id]) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
