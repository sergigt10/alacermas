        ...
        <div class="parallax" style="background-image: url({{ asset('frontend/assets/images/pattren-2.png') }});"></div>
            <div class="container">
                <div class="row space align-items-center">
                    <div class="col-lg-6">
                        <div class="data">
                            <h2>@lang("Distribución de productos") <span style="color: #CCCCCC">@lang("Acero inoxidable")</span></h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="data space">
                            <p>@lang("Aluminio, metales no férricos, plásticos técnicos y todos los suministros industriales que pueden intervenir en los procesos de transformación de estos materiales. Contamos con maquinaria para aplanar y cortar chapa.")</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <a href="{{ route('frontend.productes.index', ['categoria' => 'normalizados-inoxidable']) }}">
                        <div class="history-data">
                            ...
                            <div class="details">
                                <h3>@lang("Normalizados inoxidable")</h3>
                                <p>@lang("Los cilindros inoxidables que fabricamos están dentro de la norma ISO. Son intercambiables con las marcas existentes en el mercados.")</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <a href="{{ route('frontend.productes.index', ['categoria' => 'suministros-industriales']) }}">
                        <div class="history-data">
                            ...
                            <div class="details">
                                <h3>@lang("Suministros Industriales")</h3>
                                <p>@lang("Somos una empresa de suministros industriales con experiencia, tornillería industrial, abrasivos y maquinaria, herramientas y ferretería industrial.")</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <a href="{{ route('frontend.productes.index', ['categoria' => 'aluminio']) }}">
                        <div class="history-data">
                            ...
                            <div class="details">
                                <h3>@lang("Aluminio")</h3>
                                <p>@lang("Empresa dedicada a la venta y distribución de chapas y perfiles de aluminio a medida y en aleaciones especiales.")</p>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <div class="heading-style-2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="data">
                            <span>@lang("Nuestros centros")</span>
                            <h2>@lang("Centros Alacer Mas")</h2>
                        </div>
                    </div> 
